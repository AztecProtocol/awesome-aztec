...
- [Authentication Witness](https://docs.aztec.network/aztec/concepts/advanced/authwit) - authentication witnesses are like token approvals on Ethereum, but are much more flexible and powerful.
